...
const DiscoverStories: React.FC = () => {
  ...
  return (
    <section id="stories" className="w-full bg-gradient-to-br from-gray-50 to-blue-50 py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        <div className={`transition-all duration-1000 delay-300 ease-out ${
          ...
          <p className="text-xl text-gray-600 mb-16 max-w-3xl mx-auto leading-relaxed">
            Dive into inspiring stories and groundbreaking discoveries shaping the
        ...
        {/* Animated CTA */}
        <div className={`mt-16 transition-all duration-1000 delay-1000 ease-out ${
          isVisible 
            ? 'transform translate-y-0 opacity-100' 
            : 'transform translate-y-8 opacity-0'
        }`}>
